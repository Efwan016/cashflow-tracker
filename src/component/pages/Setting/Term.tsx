...
const PAGE_SEO = {
  title: 'Syarat & Ketentuan | Cashflow Tracker',
  description: 'Baca syarat ketentuan penggunaan aplikasi pencatat keuangan Cashflow Tracker.',
  canonical: 'https://adzanitech.web.id/terms',
