    ...
    <section className="rounded-[40px] border border-white/10 bg-gradient-to-br from-slate-900/90 to-slate-950/80 p-8 shadow-2xl shadow-slate-950/20 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className={`rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider transition-all ${
          isWithStock ? 'bg-gradient-to-r from-sky-500/10 to-indigo-500/10 text-sky-400 border border-sky-500/20' : 'bg-gradient-to-r from-amber-500/10 to-orange-500/10 text-amber-400 border border-amber-500/20'
        }`}>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-3xl bg-gradient-to-br from-slate-950/50 to-slate-900/60 p-6 border border-slate-800 shadow-lg">
