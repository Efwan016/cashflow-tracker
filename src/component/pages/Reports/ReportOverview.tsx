    ...
    <section className="mt-8 grid gap-6 xl:grid-cols-[1.4fr_0.95fr]">
      <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-700 dark:bg-slate-950/80">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">{t('Month comparison')}</p>
            <h3 className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">{t('This month vs last month')}</h3>
          </div>
          <p className="text-sm text-slate-500 dark:text-slate-400">{t('Revenue, cost, and profit performance.')}</p>
        </div>
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-xs uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400">{t('This month revenue')}</p>
            <p className="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">{fmt.format(currentMonthTotals.revenue)}</p>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{(Math.round(monthlyRevenueGrowth * 10) / 10 >= 0 ? '+' : '') + `${Math.round(monthlyRevenueGrowth * 10) / 10}%`} {t('vs last month')}</p>
          </div>
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-xs uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400">{t('This month profit')}</p>
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{(Math.round(monthlyProfitGrowth * 10) / 10 >= 0 ? '+' : '') + `${Math.round(monthlyProfitGrowth * 10) / 10}%`} {t('vs last month')}</p>
          </div>
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-xs uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400">{t('This month expenses')}</p>
            <p className="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">{fmt.format(currentMonthTotals.expenses)}</p>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">{(Math.round(monthlyExpenseGrowth * 10) / 10 >= 0 ? '+' : '') + `${Math.round(monthlyExpenseGrowth * 10) / 10}%`} {t('vs last month')}</p>
          </div>
        </div>
      ...
      <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-700 dark:bg-slate-950/80">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">{t('Current month summary')}</p>
            <h3 className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">{t('Snapshot by the numbers')}</h3>
          </div>
        ...
        <div className="mt-6 space-y-4">
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-sm text-slate-500 dark:text-slate-400">{t('Revenue change')}</p>
          ...
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-sm text-slate-500 dark:text-slate-400">{t('Profit change')}</p>
          ...
          <div className="rounded-3xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900/90">
            <p className="text-sm text-slate-500 dark:text-slate-400">{t('Expense change')}</p>
