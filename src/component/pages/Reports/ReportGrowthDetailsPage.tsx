      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:py-10 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-10 rounded-3xl sm:rounded-[40px] border border-black/5 dark:border-white/10 bg-white dark:bg-slate-950/80 p-5 sm:p-8 shadow-xl dark:shadow-[0_30px_120px_-50px_rgba(15,23,42,0.85)] backdrop-blur-xl transition-colors">
          <div className="flex items-start sm:items-center gap-4 mb-4">
            ...
            <div>
              <p className="text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.35em] text-sky-600 dark:text-sky-300/80">Performance Analysis</p>
              <h1 className="mt-2 text-xl sm:text-3xl font-semibold text-slate-900 dark:text-white">Growth & Performance Metrics</h1>
            </div>
          </div>
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
            Comprehensive view of your business growth rates and performance averages.
          </p>
        </div>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-sm text-slate-500 animate-pulse">Analyzing performance data...</p>
          </div>
        )}
        ...
        <section className="mb-10">
          <div className="mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Growth Rate Analysis</h2>
            </div>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Track key growth indicators and performance trends
            </p>
          </div>
        ...
        <section className="mb-10">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Business Efficiency</h2>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Ratios to measure how effectively you generate profit</p>
          </div>
          <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 dark:border-slate-700 dark:bg-slate-950/80">
              <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">Gross Margin</p>
              <div className="text-3xl sm:text-4xl font-black text-emerald-500">{grossMargin.toFixed(1)}%</div>
              <p className="mt-2 text-xs text-slate-500">Percentage of revenue kept after COGS.</p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 dark:border-slate-700 dark:bg-slate-950/80">
              <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">Net Margin</p>
              <div className="text-3xl sm:text-4xl font-black text-sky-500">{netMargin.toFixed(1)}%</div>
              <p className="mt-2 text-xs text-slate-500">Actual profit percentage after all costs.</p>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 dark:border-slate-700 dark:bg-slate-950/80">
              <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">Expense Ratio</p>
              <div className="text-3xl sm:text-4xl font-black text-rose-500">{expenseRatio.toFixed(1)}%</div>
              <p className="mt-2 text-xs text-slate-500">Portion of revenue consumed by expenses.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 rounded-3xl sm:rounded-[40px] border border-slate-200 bg-white overflow-hidden dark:border-slate-700 dark:bg-slate-950/80">
          <div className="p-6 sm:p-8 border-b border-slate-100 dark:border-slate-800">
            <h2 className="text-xl font-semibold">Comparative Performance</h2>
            <p className="text-sm text-slate-500 mt-1">Direct comparison with the previous period</p>
          </div>
            ...
            <table className="w-full text-left min-w-[600px]">
              <thead className="bg-slate-50 dark:bg-slate-900/50 text-xs uppercase tracking-wider text-slate-500">
                <tr>
                  ...
                  <th className="px-8 py-4">Previous Period</th>
                  <th className="px-8 py-4">Current Period</th>
                  <th className="px-8 py-4">Delta</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                <tr>
                  <td className="px-8 py-5 font-medium">Total Revenue</td>
                ...
                <tr>
                  <td className="px-8 py-5 font-medium">Gross Profit</td>
                ...
                <tr>
                  <td className="px-8 py-5 font-medium">Total Expenses</td>
        ...
        <section>
          <div className="mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">Average Performance</h2>
            </div>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Key averages across your business operations
            </p>
          </div>
        ...
        <section className="mt-10 rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-slate-100 p-6 sm:p-8 dark:border-slate-700 dark:from-slate-900/50 dark:to-slate-900/30">
          ...
          <div className="grid gap-4 md:grid-cols-2 text-sm text-slate-600 dark:text-slate-300">
            <div>
              <p className="font-medium text-slate-900 dark:text-white mb-2">Growth Rate</p>
              <p>Percentage change compared to the previous period. Positive values indicate growth.</p>
            </div>
            <div>
              <p className="font-medium text-slate-900 dark:text-white mb-2">Averages</p>
              <p>Mean values across your selected period. Use these to understand typical performance.</p>
            </div>
          </div>
        </section>
          </>
