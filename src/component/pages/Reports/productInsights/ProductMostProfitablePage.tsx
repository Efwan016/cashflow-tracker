                  ...
                  {paginatedProducts.map((item, index) => (
                    <tr key={item.name} className="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors">
                      <td className="px-6 py-5">
                        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-50 dark:bg-amber-500/10 text-xs font-black text-amber-600 dark:text-amber-400 border border-amber-100">
                      ...
                      <td className="px-6 py-5 font-medium">{fmt.format(item.revenue)}</td>
